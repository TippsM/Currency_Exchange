...
currency_Exchange = st.secrets["CURRENCY_EXCHANGE"]
...
def getListOf_Currencies():
    currency_list = f"https://api.currencylayer.com/list?access_key={currency_Exchange}"
